...
\input{freeda1.sty}
\begin{document}
\noindent{\LARGE \textbf{N Channel JFET}
\hspace{\fill}\textbf{jfetn}}
\hrulefill\linethickness{0.5mm}\line(1,0){425}
\normalsize
\newline
% the resistor figure
\begin{figure}[h]
\centerline{\epsfxsize=4in\epsfbox{figures/j.ps}} \caption{JFET Types (a)
...
\newline
\textit{Example:}%%%%%Template%%%%%%%%%%%%
\newline
\texttt{jfetn:j1\ 3\ 4\ 2\ beta=0.0001}
\newline
\linethickness{0.5mm} \line(1,0){425}
\newline
\textit{Description:}\\%%%%%%%%%%Template%%%%%%%%%%%%%%
...
\noindent{\sl Inverted Mode: ($V_{DS} < 0)$}\\
