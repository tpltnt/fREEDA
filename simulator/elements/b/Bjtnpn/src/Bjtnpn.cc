...
const unsigned Bjtnpn :: n_par = 50;

ItemInfo Bjtnpn::einfo =
{
	"bjtnpn",
	"Gummel Poon model, NPN",
	"Senthil Velu",
...
Bjtnpn::Bjtnpn(const string& iname) : ADInterface(&einfo, pinfo, n_par, iname)
{
...
//evaluate function
void Bjtnpn :: eval(AD * x, AD * effort, AD * flow)
{
