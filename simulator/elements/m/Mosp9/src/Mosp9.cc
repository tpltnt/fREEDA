...
//Static members
const unsigned Mosp9::n_par = 125;

//Element information
ItemInfo Mosp9::einfo =
{
  "mosp9",
  "Philips MOS9 model",
...
ParmInfo Mosp9::pinfo[]=
{
  ...
  {"M0R", "Factor of the subthreshold slope for the reference transistor at the reference temperature (-)", TR_DOUBLE, false},
  ...
  //{"TOX", "Thickness of the gate-oxide layer. tox is used for calculation of 1/f noise and Cox, not for BET!!! (m)", TR_DOUBLE, false},
...
Mosp9::Mosp9(const string& iname) : ADInterface(&einfo,pinfo,n_par,iname)
{
  //Set default parameter values (electrical model) p-channel
  paramvalue[0] = &(LEVEL = 903);
  paramvalue[1] = &(VT0 = 1.082125);
  paramvalue[2] = &(K0 = 4.280174e-01);
  paramvalue[3] = &(K = 4.280174e-01);
  paramvalue[4] = &(PHIB = 6.225999e-01);
  paramvalue[5] = &(VSBX = 1.000000e-12);
  paramvalue[6] = &(BET = 4.841498e-04);
  paramvalue[7] = &(THE1 = 2.046809e-01);
  paramvalue[8] = &(THE2 = 1.492490e-01);
  paramvalue[9] = &(THE3 = 3.267633e-02);
  paramvalue[10] = &(GAM1 = 9.905701e-01);
  paramvalue[11] = &(ETADS = 6.000000e-01);
  paramvalue[12] = &(ALP = 4.766925e-02);
  paramvalue[13] = &(VP = 1.861200e-01);
  paramvalue[14] = &(GAM00 = 1.118334e-02);
  paramvalue[15] = &(ETAGAM = 1.000000);
  paramvalue[16] = &(M0 = 3.801987e-01);
  paramvalue[17] = &(ETAM = 1.000000);
  paramvalue[18] = &(PHIT = 2.662680e-02);
  paramvalue[19] = &(ZET1 = 1.270446);
  paramvalue[20] = &(VSBT = 1.000000e02);
  paramvalue[21] = &(A1 = 6.858299);
  paramvalue[22] = &(A2 = 5.732410e01);
  paramvalue[23] = &(A3 = 4.254087e-01);
  paramvalue[24] = &(COX = 2.717113e-014);
  paramvalue[25] = &(CGDO = 6.358400e-15);
  paramvalue[26] = &(CGSO = 6.358400e-15);
  paramvalue[27] = &(NT = 2.216522e-20);
  paramvalue[28] = &(NFMOD = 0);
  paramvalue[29] = &(NF);
  paramvalue[30] = &(NFA = 1.53e22);
  paramvalue[31] = &(NFB = 4.06e6);
  paramvalue[32] = &(NFC = 2.92e-10);
  paramvalue[33] = &(TOX = 25e-9);
  paramvalue[34] = &(MULT = 1.0);
  //Geometrical model. p-channel
  paramvalue[35] = &(LER = 1.25e-6);
  paramvalue[36] = &(WER = 20e-6);
  paramvalue[37] = &(LVAR = -0.460e-6);
  paramvalue[38] = &(LAP = 0.025e-6);
  paramvalue[39] = &(WVAR = -0.130e-6);
  paramvalue[40] = &(WOT = 0.000e-6);
  paramvalue[41] = &(TR = 21.00);
  paramvalue[42] = &(VT0R = 1.100);
  paramvalue[43] = &(STVT0 = -1.7e-3);
  paramvalue[44] = &(SLVT0 = 0.035e-6);
  paramvalue[45] = &(SL2VT0 = 0.0);
  paramvalue[46] = &(SL3VT0 = 0.0);
  paramvalue[47] = &(SWVT0 = 0.050e-6);
  paramvalue[48] = &(K0R = 0.470);
  paramvalue[49] = &(SLK0 = -0.200e-6);
  paramvalue[50] = &(SL2K0 = 0.0);
  paramvalue[51] = &(SWK0 = 0.115e-6);
  paramvalue[52] = &(KR = 0.470);
  paramvalue[53] = &(SLK = -0.200e-6);
  paramvalue[54] = &(SL2K = 0.0);
  paramvalue[55] = &(SWK = 0.115e-6);
  paramvalue[56] = &(PHIBR = 0.650);
  paramvalue[57] = &(VSBXR = 1.0e-12);
  paramvalue[58] = &(SLVSBX = 0.0);
  paramvalue[59] = &(SWVSBX = 0.0);
  paramvalue[60] = &(BETSQ = 26.1e-6);
  ...
  paramvalue[68] = &(SLTHE1R = 0.17e-6);
  paramvalue[69] = &(STLTHE1 = 0.000e-3);
  paramvalue[70] = &(GTHE1 = 0.0);
  paramvalue[71] = &(SWTHE1 = -0.080e-6);
  paramvalue[72] = &(WDOG = 0.0);
  paramvalue[73] = &(FTHE1 = 0.0);
  paramvalue[74] = &(THE2R = 0.165);
  paramvalue[75] = &(STTHE2R = 0.000e-9);
  paramvalue[76] = &(SLTHE2R = -0.075e-6);
  paramvalue[77] = &(STLTHE2 = 0.000e-3);
  paramvalue[78] = &(SWTHE2 = 0.020e-6);
  paramvalue[79] = &(THE3R = 0.027);
  paramvalue[80] = &(STTHE3R = 0.000e-9);
  paramvalue[81] = &(SLTHE3R = 0.027e-6);
  paramvalue[82] = &(STLTHE3 = 0.000e-3);
  paramvalue[83] = &(SWTHE3 = 0.011e-6);
  paramvalue[84] = &(GAM1R = 0.077);
  paramvalue[85] = &(SLGAM1 = 0.105e-6);
  paramvalue[86] = &(SWGAM1 = -0.011e-6);
  paramvalue[87] = &(ETADSR = 0.600);
  paramvalue[88] = &(ALPR = 0.044);
  paramvalue[89] = &(ETAALP = 0.17);
  paramvalue[90] = &(SLALP = 9e-3);
  paramvalue[91] = &(SWALP = 0.180e-9);
  paramvalue[92] = &(VPR = 0.235);
  paramvalue[93] = &(GAM00R = 0.007);
  paramvalue[94] = &(SLGAM00 = 11.0e-15);
  paramvalue[95] = &(SL2GAM00 = 0.0);
  paramvalue[96] = &(ETAGAMR = 1.0);
  paramvalue[97] = &(M0R = 0.375);
  paramvalue[98] = &(STM0 = 0.000);
  paramvalue[99] = &(SLM0 = 0.047e-3);
  paramvalue[100] = &(ETAMR = 1.0);
  paramvalue[101] = &(ZET1R = 1.30);
  paramvalue[102] = &(ETAZET = 0.03);
  paramvalue[103] = &(SLZET1 = -2.80);
  paramvalue[104] = &(VSBTR = 100.0);
  paramvalue[105] = &(SLVSBT = 0.0e-6);
  paramvalue[106] = &(A1R = 10.00);
  paramvalue[107] = &(STA1 = 0.000);
  paramvalue[108] = &(SLA1 = -15.0e-6);
  paramvalue[109] = &(SWA1 = 30.0e-6);
  paramvalue[110] = &(A2R = 59.0);
  paramvalue[111] = &(SLA2 = -8.00e-6);
  paramvalue[112] = &(SWA2 = 15.0e-6);
  paramvalue[113] = &(A3R = 0.520);
  paramvalue[114] = &(SLA3 = -0.450e-6);
  paramvalue[115] = &(SWA3 = -0.140e-6);
  paramvalue[116] = &(COL = 0.320e-9);
  paramvalue[117] = &(NTR = 0.211e-19);
  paramvalue[118] = &(NFR=-.214e-10);
  paramvalue[119] = &(NFAR = 1.53e22);
  paramvalue[120] = &(NFBR = 4.06e6);
  paramvalue[121] = &(NFCR = 2.92e-10);
...
void Mosp9::eval(AD * x, AD * effort, AD * flow)
{
  //State variables
  AD vds,vgs,vsb;
  ...
  GPER = FBET1 * LP1/LER * (1.0 - exp(-LER/LP1)) + FBET2 * LP2/LER * (1.0 - exp(-LER/LP2));
  ...
  K0 = K0R + (1.0/LE - 1.0/LER) * SLK0 + (1.0/pow(LE,2) - 1.0/pow(LER,2)) * SL2K0
       + (1.0/WE - 1.0/WER) * SWK0;
  K = KR + (1.0/LE - 1.0/LER) * SLK + (1.0/pow(LE,2) - 1.0/pow(LER,2)) * SL2K
      + (1.0/WE - 1.0/WER) * SWK;
  ...
  if (w > WDOG)
  {
    THE1 = THE1TILDA + (1.0/(LE * (1.0 + GTHE1*GPE)) - 1.0/(LER * (1.0 + GTHE1 * GPER)))
           * SLTHE1 + (1.0/WE - 1.0/WER) * SWTHE1;
  }
  else
  {
  ...
  double THE2TILDA, THE3TILDA, SLTHE2, SLTHE3;

  THE2TILDA = THE2R + (TKD - TKR) * STTHE2R;
  SLTHE2 = SLTHE2R + (TKD - TKR) * STLTHE2;
  THE2 = THE2TILDA + (1.0/LE - 1.0/LER) * SLTHE2 + (1.0/WE - 1.0/WER) * SWTHE2;
  THE3TILDA = THE3R + (TKD - TKR) * STTHE3R;
  SLTHE3 = SLTHE3R + (TKD - TKR) * STLTHE3;
  THE3 = THE3TILDA + (1.0/LE - 1.0/LER) * SLTHE3 + (1.0/WE - 1.0/WER) * SWTHE3;
  //---------end Threshold-Voltage Parameters---------

  //---------Calculation of Drain-Feedback Parameters---------
  GAM1 = GAM1R + (1.0/LE - 1.0/LER) * SLGAM1 + (1.0/WE - 1.0/WER) * SWGAM1;
  ETADS = ETADSR;
  ALP = ALPR + (1.0/pow(LE,ETAALP) - 1.0/pow(LER,ETAALP) * SLALP + (1.0/WE - 1.0/WER)) * SWALP;
  VP = VPR * (LE / LER);
  ...
  double eps4 = 5e-4;
  double lambda1 = 0.1, lambda2 = 1e-4;
  ...
  double lambda9 =0.1, eps8= 0.001;
  AD vdss1;
  vdss1 = (vgt3/(1.0 + del1)) * (2.0/(1.0 + sqrt(lambda9 + hyp1(1.0 - lambda9
          + (2.0 * THE3 * vgt3/(1.0 + del1)),eps8))));

  double lambda6= 0.3, vdssx=1;
  AD vds1;
  AD eps5;
  ...
  AD ids;
  ids = BET * g3 * ((vgt3 * vds1 - ((1.0 + del1)/2) * pow(vds1,2))/((1.0 + THE1
        * vgt1 + THE2 * (us - us0)) * (lambda9 + hyp1(1.0 - lambda9 + THE3 * vds1,eps8))));
  ...
  diff_gam0_vsb = GAM00 * (ETAGAM - 1.0) * (1.0/us0) * pow(us1,ETAGAM-1)
                 * diff_hyp2(us,ust,eps3) * (0.5/sqrt(h1))
                 * diff_hyp1(vsb + lambda10*PHIB,eps1);

  diff_delta_vt1_vsb = (pow(vds,2)/(vds+lambda1)) * (-diff_gam0_vsb
                       - (GAM1*pow(vds + lambda2,ETADS-1) - gam0)
                      * 2.0 * vgt1 * diff_vgt1_vsb
                      * pow(vgtx,2)/(pow(pow(vgtx,2) + pow(vgt1,2),2))
  ...
  diff_vt2_vds = (-gam0 - (GAM1 * pow(vds + lambda2,ETADS-1) - gam0)
                 * (pow(vgt1,2)/(pow(vgtx,2) + pow(vgt1,2))))
                 * ((pow(vds,2) + 2 * lambda1 * vds)/pow(vds + lambda1,2))
  ...
  diff_g1_vsb = exp(vgt2/temp) * (temp*diff_vt2_vsb - diff_m_vsb*vgt2*2*PHIT)/pow(temp,2);
  ...
  {
    diff_vgt3_vsb = (2.0 * diff_m_vsb * PHIT * log(1.0 + g1)) + (temp * diff_g1_vsb/(1.0 + g1));
  ...
  AD fj;
  fj=((1.0 + del2) * (lambda9 + hyp1(1.0 - lambda9 + THE3 * vds2,eps8))
     * vds2)/(2.0 * vgt3 - (1.0 + del2) * vds2);
  ...
  if (vgb > vfb)
  {
    qbs = -COX * K0 * (-K0/2.0 + (sqrt(pow(K0/2,2) + hyp3(vgb-vfb,vsb+vt1-vfb,eps6))));
    qbd = -COX * K0 * (-K0/2.0 + (sqrt(pow(K0/2,2) + hyp3(vgb-vfb,vds2+vsb+vt1d-vfb,eps6))));
  }
  else
  {
...
AD Mosp9:: hyp1( AD x, double EPI)
{
	return (0.5*(x+sqrt(x * x + 4 * EPI * EPI)));
}

AD Mosp9:: hyp1( AD x, AD EPI)
{
	return (0.5*(x+sqrt(x * x + 4 * EPI * EPI)));
}

AD Mosp9::diff_hyp1( AD x, double EPI)
{
	return (0.5*(1+ x/sqrt(x * x + 4 * EPI * EPI)));
}

AD Mosp9::hyp2( AD x, AD x0, double EPI)
{
	return(x - EPI - hyp1(x-x0,EPI));
}

AD Mosp9::diff_hyp2( AD x, AD x0, double EPI)
{
	return(1- diff_hyp1(x-x0,EPI));
}

AD Mosp9::hyp3( AD x, AD x0, double EPI)
{
	return(hyp2(x,x0,EPI) - hyp2(0,x0,EPI));
}

AD Mosp9::diff_hyp3( AD x, AD x0, double EPI)
{
	return(diff_hyp2(x,x0,EPI));
}

AD Mosp9::hyp4( AD x, double x0, double EPI)
{
	return(hyp1(x-x0, EPI) - hyp1(-x0, EPI));
}

AD Mosp9::diff_hyp4( AD x, double x0, double EPI)
{
	return(diff_hyp1(x-x0,EPI));
}

AD Mosp9::hyp5( AD x, AD x0, AD EPI)
{
	return(x0 - hyp1(x0 - x - EPI * EPI/x0 ,EPI));
}

AD Mosp9::diff_hyp5( AD x, AD x0, double EPI)
{
