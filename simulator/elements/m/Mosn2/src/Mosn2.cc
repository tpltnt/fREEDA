...
// Static members
const unsigned Mosn2::n_par = 31;

// Element information
ItemInfo Mosn2::einfo =
{
  "mosn2",
...
Mosn2::Mosn2(const string& iname) : ADInterface(&einfo, pinfo, n_par, iname)
{
...
void Mosn2::eval(AD * x, AD * effort, AD * flow)
{
  // x[0]: vds
  // x[1]: vgs
  // x[2]: vbs
  ...
  // No test for inverse connection of source and drain nodes
	// from node convention
