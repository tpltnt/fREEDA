...
const unsigned CmosNand :: n_par = 12;

// Element Information
ItemInfo CmosNand::einfo =
{
	"cmosnand",
	"CMOS NAND Gate",
	"Mazen M Kharbutli",
...
// Constructor
CmosNand::CmosNand(const string& iname) : ADInterface(&einfo, pinfo, n_par, iname)
{
...
void CmosNand::init() throw(string&)
{
...
// Evaluate Function
void CmosNand::eval(AD * x, AD * effort, AD * flow)
{
