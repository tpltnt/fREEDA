// ThermalHeatsinkSpot is an n-port thermal element
//
//	        +-----+
//        0  o--+     |
//        1  o--+     |
...
#ifndef ThermalHeatsinkSpot_h
#define ThermalHeatsinkSpot_h 1

class ThermalHeatsinkSpot : public Element
{
	public:

  ThermalHeatsinkSpot(const string& iname);
  ...
  // Internal functions
  double LaplaceDomain(int i, double s);
