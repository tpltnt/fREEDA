...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% The title
%\begin{document}
\section[F \- Current-Controlled Current Source]{\noindent{\LARGE \textbf{Current-Controlled Current Source} \hspace{35mm}\huge\textbf{F}}}
%\newline
\linethickness{1mm}
\line(1,0){425}
\normalsize
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% the resistor figure
\begin{figure}[h]
\centerline{\epsfxsize=3in\pfig{f_spice.ps}} \caption{F ---
...
An example of a current-controlled current source is:\\[0.1in]
\hspace*{\fill}\offsetparbox{F1 2 3 POLY(4) VIN V2 (11,0) (13,0)
0.5 1 1 1 1 0.2 0.3 0.2.}
\newline
