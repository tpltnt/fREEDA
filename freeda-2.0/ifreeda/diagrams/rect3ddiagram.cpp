...
/*  if(xAxis.autoScale) {
  ...
  Lines.append(new Line(xorig, yorig, coord[0], coord[1], QPen(Qt::black,0)));

  px = &xAxis.up;
  py = &yAxis.up;
  pz = val;
  calcCoordinate(px, pz, py, &coord[2], &coord[3], &zAxis);  // xy area
  Lines.append(new Line(coord[0], coord[1], coord[2], coord[3], QPen(Qt::lightGray,0)));

  px = &xAxis.low;
  py = &yAxis.up;
  pz = val;
  calcCoordinate(px, pz, py, &coord[4], &coord[5], &zAxis);   // y axis
  Lines.append(new Line(xorig, yorig, coord[4], coord[5], QPen(Qt::black,0)));
  Lines.append(new Line(coord[4], coord[5], coord[2], coord[3], QPen(Qt::lightGray,0)));
  ...
  Lines.append(new Line(coord[4], coord[5], coord[6], coord[7], QPen(Qt::lightGray,0)));

  px = &xAxis.low;
  py = &yAxis.low;
  pz = val;
  calcCoordinate(px, pz, py, &coord[8], &coord[9], &zAxis);   // z axis
  Lines.append(new Line(xorig, yorig, coord[8], coord[9], QPen(Qt::black,0)));
  Lines.append(new Line(coord[8], coord[9], coord[6], coord[7], QPen(Qt::lightGray,0)));
  ...
  Lines.append(new Line(coord[0], coord[1], coord[10], coord[11], QPen(Qt::lightGray,0)));
  Lines.append(new Line(coord[8], coord[9], coord[10], coord[11], QPen(Qt::lightGray,0)));
