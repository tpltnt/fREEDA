//         ELECTRO-THERMAL MODEL of CMOS Inverter
//
//
//                  Vdd 1
//                      o
...
// The CmosInvT Class
class CmosInvT : public ADInterface
{
	public:

  CmosInvT(const string& iname);
  ...
  double xj_n, xj_p, dw_n, dw_p, dl_n, dl_p,gamma_n,gamma_p,rth;
