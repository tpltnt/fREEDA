// This is a v-to-v transducer implementing a Z-domain Butterworth
...
class Zbutter : public Element
{
  public:

    Zbutter(const string& iname);
  ...
  private:
    ...
    double tee, epsilon, lambda, wls, wlp, whs, whp, wp, ws, wc,
           wsh, wsl, wo2, wo;
    int N, k, kmax;
    double Nd; // cast of N into double when given in pord
