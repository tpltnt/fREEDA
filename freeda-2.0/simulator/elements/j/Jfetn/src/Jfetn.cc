...
//Static members
const unsigned Jfetn::n_par=20;

//Information about this element
ItemInfo Jfetn::einfo=
{
  "jfetn",
  "The n-channel JFET based on the SPICE model",
  "Nikhil Kriplani, Shubha Vijaychand",
  DEFAULT_ADDRESS"category:transistor>jfet",
  "2001_05_20"
};

ParmInfo Jfetn::pinfo[] =
{
...
Jfetn::Jfetn(const string& iname) : ADInterface(&einfo, pinfo, n_par, iname)
{
  paramvalue[0] = & (af = one);
...
void Jfetn::eval(AD * x, AD * effort, AD * flow)
{
  // x[0] : vds
  // x[1] : vgs
  // x[2] : dvds/dt
