...
#include <qhash.h>
#include <qfileinfo.h>
// Above lines added by shivam to remove header file errors

#include <q3vbox.h>
#include <qlayout.h>
// Changed by Shivam qhbuttongroup.h to q3hbuttongroup
...
//                   SLOT(slotTakeVar(QListViewItem*, const QPoint &,int)));
  ...
  if(Diag->Name != "Tab") {
    ...
    Q3GridLayout *gp = new Q3GridLayout(Tab2,12,3,5,5);
    ...
    if(Diag->Name != "Rect3D") {
      ...
      if(!Diag->xAxis.GridOn) slotSetGridBox(QCheckBox::Off);
  ...
  // ...........................................................
    ...
    // ...........................................................
    // transfer the diagram properties to the dialog
    if(Diag->xAxis.autoScale)  slotManualX(QCheckBox::Off);
    else  manualX->setChecked(true);
    if(Diag->yAxis.autoScale)  slotManualY(QCheckBox::Off);
    else  manualY->setChecked(true);
    if(Diag->zAxis.autoScale)  slotManualZ(QCheckBox::Off);
...
void DiagramDialog::slotReadVars(int)
{
  ...
  do {
    ...
    if(Line.left(3) == "dep") {
      tmp = Line.section(' ', 2);
      new Q3ListViewItem(ChooseVars, Line.section(' ', 1, 1).remove('>'),
			"dep", tmp.remove('>'));
    }
